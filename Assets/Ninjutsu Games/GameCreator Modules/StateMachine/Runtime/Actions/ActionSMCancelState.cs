...
{
    [AddComponentMenu("")]
    public class ActionSMCancelState : IAction
    {
...
#if UNITY_EDITOR
        public static new string NAME = "State Machine/Cancel State";
        private const string NODE_TITLE = "Cancel State {0}";
