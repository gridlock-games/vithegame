...
namespace Vi.Editor
{
    ...
    public class ActionClipEditor : UnityEditor.Editor
    {
        ...
        private SerializedProperty spChargeAttackChargingVFX;
        ...
        private SerializedProperty spMagicalDamage;
        ...
        private void OnEnable()
        {
            ...
            spChargeAttackChargingVFX = serializedObject.FindProperty("chargeAttackChargingVFX");
            ...
            spMagicalDamage = serializedObject.FindProperty("magicalDamage");
        ...
        public override void OnInspectorGUI()
        {
            ...
            if ((ActionClip.ClipType)spClipType.enumValueIndex == ActionClip.ClipType.LightAttack)
            {
                ...
                EditorGUILayout.PropertyField(spMagicalDamage);
            ...
            else if ((ActionClip.ClipType)spClipType.enumValueIndex == ActionClip.ClipType.HeavyAttack)
            {
                ...
                EditorGUILayout.PropertyField(spChargeAttackChargingVFX);
                EditorGUILayout.Space();
