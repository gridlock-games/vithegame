...
namespace Vi.Editor
{
    ...
    public class ActionClipEditor : UnityEditor.Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            if ((ActionClip.ClipType)spClipType.enumValueIndex == ActionClip.ClipType.LightAttack | (ActionClip.ClipType)spClipType.enumValueIndex == ActionClip.ClipType.FlashAttack)
            {
