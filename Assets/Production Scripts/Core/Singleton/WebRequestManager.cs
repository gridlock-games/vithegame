...
namespace Vi.Core
{
  public class WebRequestManager : MonoBehaviour
  {
    ...
    { StartCoroutine(ServerGetRequest()); }
    ...
    { StartCoroutine(DeleteServerCoroutine(serverId)); }
    ...
    public void ResetLogInErrorText()
    { LogInErrorText = ""; }
    ...
    { StartCoroutine(CharacterGetRequest()); }
    ...
    { StartCoroutine(CharacterByIdGetRequest(characterId)); }
    ...
    { return new Character("", "Human_Male", "", 0, 1, GetDefaultLoadout(), GetDefaultLoadout(), GetDefaultLoadout(), GetDefaultLoadout(), CharacterReference.RaceAndGender.HumanMale); }
