    ...
    public class WeaponHandler : NetworkBehaviour
    {
        ...
        private void Aim(bool isAiming, bool instantAim)
        {
            foreach (KeyValuePair<Weapon.WeaponBone, GameObject> instance in weaponInstances)
            {
                ...
                {
                    animationHandler.LimbReferences.AimHand(shooterWeapon.GetAimHand(), shooterWeapon.GetAimHandIKOffset(), isAiming, instantAim, animationHandler.IsAtRest() || CurrentActionClip.shouldAimBody, shooterWeapon.GetBodyAimIKOffset(), shooterWeapon.GetBodyAimType());
